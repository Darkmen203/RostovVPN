...
import com.rostovvpn.rostovvpn.bg.BoxService
...
class MethodHandler(private val scope: CoroutineScope) : FlutterPlugin,
    ...
    companion object {
        ...
        const val channelName = "com.rostovvpn.app/method"

        enum class Trigger(val method: String) {
            Setup("setup"),
            ParseConfig("parse_config"),
            changeRostovvpnOptions("change_rostovvpn_options"),
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            Trigger.changeRostovvpnOptions.method -> {
                scope.launch {
                    result.runCatching {
