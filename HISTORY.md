...
* Fix links on website, added gen to publish cdn, delete winget.yml. 

* Change icons for app, fix url in add_signed_microsoft, fix names. 

* New keys for msix, try added build msix. 

* Commented iss artifact it`s for debug. 

* Fix exe make_config path to icon. 

* Fix auto path. 

* Reorganizations build.yml. 

* Added auto path to icon. 

* Trying logs build iss. 

* Added to logs and to artifact file  *.iss. 

* Fix path, added logs on dist directory. 

* Fix build windows. 

* Fix path to ico in windows build. 

* Remove msix build. 

* Try fix windows setup building. 

* Try fix. 

* New logic find file release. 

* Try strict path and reserved path. 

* Fix path in ensure proper windows installer. 

* Added find biggest installer. 

* Edited fallback. 

* Added fallback where empty windows setup. 

* Added install inno setup in CI. 

* Try fix windows setup build. 

* Try fix windows setup build. 

* Fix makefile, edited docs, rename macos and ios. 

* Edited makefile urls, new license and rename appinfo. 
...
* Fix bugs for system tray and new logic for refresh on startup. 
...
* Added logo, change icon windows, and fix name. 
