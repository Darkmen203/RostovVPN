...
ifeq ($(CHANNEL),prod)
	CORE_URL=https://github.com/Darkmen203/rostovvpn-core/releases/download/v$(core.version)
else
	CORE_URL=https://github.com/Darkmen203/rostovvpn-core/releases/download/draft
endif
